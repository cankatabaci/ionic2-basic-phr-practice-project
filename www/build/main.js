...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__bloodsugar_bloodsugar__ = __webpack_require__(125);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__bloodpress_bloodpressdetails_bloodpressdetails__ = __webpack_require__(235);
        ...
        alert.addButton({
            ...
            handler: function (data) {
                ...
                switch (data) {
                    ...
                    case 'bloodpress': {
                        _this.navCtrl.push(__WEBPACK_IMPORTED_MODULE_8__bloodpress_bloodpressdetails_bloodpressdetails__["a" /* BloodPressDetailsPage */]);
                        break;
                    }
                    default: {
                        //statements; 
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(21);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__home_home__ = __webpack_require__(124);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var BloodSugarPage = (function () {
    function BloodSugarPage(platform, navCtrl, alertCtrl, navParams, toastCtrl) {
        ...
        this.notes = [];
        this.item = { value: 0, day: "", date: "", bloodsugarid: 0, isactive: true };
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__bloodsugar__ = __webpack_require__(125);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var BloodSugarDetailsPage = (function () {
    function BloodSugarDetailsPage(navCtrl, alertCtrl, navParams, toastCtrl, builder) {
        this.navCtrl = navCtrl;
        this.alertCtrl = alertCtrl;
        this.navParams = navParams;
        this.toastCtrl = toastCtrl;
        this.builder = builder;
        this.items = { day: "", date: "", bloodsugarid: 0, isactive: true };
        this.tarih = { day: "", month: "", year: "" };
        this.num = [];
        this.navCtrl.canGoBack();
        var i;
        var j = 0;
    ...
    BloodSugarDetailsPage.prototype.AddRecord = function () {
        if (this.items.value == undefined || this.items.day == "") {
            ...
            this.navCtrl.push(__WEBPACK_IMPORTED_MODULE_3__bloodsugar__["a" /* BloodSugarPage */], this.navParams.data);
        }
    };
    BloodSugarDetailsPage.prototype.presentToast = function (msj) {
        var toast = this.toastCtrl.create({
            message: msj,
            duration: 3000,
            position: 'top'
...
var BloodPressDetailsPage = (function () {
    ...
    BloodPressDetailsPage.prototype.logForm = function (form) {
        if (form.value.title === "")
            console.log("null");
...
BloodPressDetailsPage = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
        selector: 'page-bloodpressdetails',template:/*ion-inline-start:"D:\GitHub\ionic2-basic-phr-practice-project\src\pages\bloodpress\bloodpressdetails\bloodpressdetails.html"*/'<ion-header>\n\n\n\n    <ion-navbar>\n\n        <ion-title>Blood Pressure </ion-title>\n\n        <ion-buttons end>\n\n        </ion-buttons>\n\n    </ion-navbar>\n\n\n\n</ion-header>\n\n<ion-content>\n\n    <form #form="ngForm" (ngSubmit)="logForm(form)" novalidate>\n\n        <ion-item>\n\n            <ion-label>Todo</ion-label>\n\n            <ion-input type="text" required [(ngModel)]="todo.title" #Title="ngModel" ngControl="title" name="title" required></ion-input>\n\n            <div *ngIf="form.submitted && !Title.valid" class="help-block">Name is required</div>\n\n        </ion-item>\n\n        <ion-item>\n\n            <ion-label>Description</ion-label>\n\n            <ion-textarea [(ngModel)]="todo.description" ngControl="description" name="description"></ion-textarea>\n\n        </ion-item>\n\n        <button ion-button type="submit" block>Add Todo</button>\n\n    </form>\n\n</ion-content>'/*ion-inline-end:"D:\GitHub\ionic2-basic-phr-practice-project\src\pages\bloodpress\bloodpressdetails\bloodpressdetails.html"*/
    }),
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__pages_bloodsugar_bloodsugar__ = __webpack_require__(125);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12_angular2_datatable__ = __webpack_require__(311);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_14__pages_bloodpress_bloodpressdetails_bloodpressdetails__ = __webpack_require__(235);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_17__ionic_native_date_picker__ = __webpack_require__(582);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
